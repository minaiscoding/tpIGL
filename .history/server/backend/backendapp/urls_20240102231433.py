...
from .views import LoginView, UtilisateursListView, ArticlesListView, AddToFavorite, SearchView,LocalUploadViewSet,ExternalUploadViewSet, get_random_user_id
#-----------------------------------------------------------------------------------------------
...
urlpatterns = [
    ...
    path('favoris/<int:user_id>/<str:article_id>/', AddToFavorite, name='add_to_favorites'),
    path('get-random-user/', get_random_user_id, name='get_random_user_id'),
