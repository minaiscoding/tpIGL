...
from .views import LoginView, UtilisateursListView, ArticlesListView, save_favorite, FavoriteArticleListView , SearchView,LocalUploadViewSet,ExternalUploadViewSet
#-----------------------------------------------------------------------------------------------

urlpatterns = [
    path('saveFavorite/', save_favorite, name='save_favorite'),
   ...
   # path('articles/<str:article_id>/', ArticleDetailView.as_view(), name='article-detail'),  # Add this line
    ...
    path('userFavoriteArticles/', FavoriteArticleListView.as_view(), name='user-favorite-articles'),
