...
class FavorisListView(generics.ListAPIView):
    ...
    if serializer.is_valid():
        ...
        # Logic to add or remove article from user's favorites
        # You need to implement this logic based on your Django models

        return Response({'message': 'Favorite updated successfully'}, status=status.HTTP_200_OK)
    else:
