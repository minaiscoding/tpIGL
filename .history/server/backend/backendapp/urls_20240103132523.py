...
from .views import LoginView, UtilisateursListView, ArticlesListView, SaveFavoriteView, SearchView,LocalUploadViewSet,ExternalUploadViewSet
#-----------------------------------------------------------------------------------------------
...
urlpatterns = [
    ...
    path('save-favorite/', SaveFavoriteView.as_view(), name='save_favorite'),
    path('api/user-favorite-articles/', FavoriteArticleListView.as_view(), name='user-favorite-articles'),
    #--------------------------------------------------------------------------------------------------#
