...
class SaveFavoriteView(APIView):
    ...
    def post(self, request):
        try:
            ...
            # Get the existing instances of Utilisateurs and Articles
        ...
        # Assuming there's only one matching article (ID is unique)
                ...
                # Create a new Articles instance using the retrieved data
                new_article = Articles(**article_data)
                new_article.save()

            else:
                # Use the existing Articles instance
                new_article = existing_article

            # Create a new Favoris instance and associate it with the Utilisateurs and Articles instances
