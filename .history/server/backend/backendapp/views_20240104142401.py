...
class SaveFavoriteView(APIView):
    ...
    def post(self, request):
        try:
            ...
            # Retrieve all instances of Articles
            all_articles = Articles.objects.all()
            print(all_articles)

            # Filter the articles based on the provided article_id
            existing_article = all_articles.filter(id=article_id).first()
            print
            ...
            if existing_article:
                ...
                # If the article doesn't exist, you may want to handle this case or return an error response
