...
from .views import LoginView, UtilisateursListView, ArticlesListView, FavoriteArticleViewSet, SearchView
...
urlpatterns = [
    ...
    path('favoris-list/', FavoriteArticleViewSet.as_view(), name='favoris-list'),
