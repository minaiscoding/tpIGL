...
const FavoriteArticles = () => {
  ...
  return (
    <div
      className="h-full w-screen min-h-screen font-Futura bg-cover bg-center p-10 justify-center"
      style={{ backgroundImage: "url(../../../images/bgimg2.svg)" }}
    >
      
        <div className="text-black text-[3vw] z-50 font-Futura-bold mb-[10vh] flex items-center justify-center h-screen">
