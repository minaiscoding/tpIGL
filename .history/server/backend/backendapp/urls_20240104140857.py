...
urlpatterns = [
    path('favoris/', SaveFavoriteView.as_view(), name='save_favorite'),
   ...
   # path('articles/<str:article_id>/', ArticleDetailView.as_view(), name='article-detail'),  # Add this line
    ...
    path('userFavoriteArticles/<int:user_id>/', FavoriteArticleListView.as_view(), name='user-favorite-articles'),
