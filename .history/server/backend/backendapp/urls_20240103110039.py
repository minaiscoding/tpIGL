...
from .views import LoginView, UtilisateursListView, ArticlesListView, FavoriteArticleViewSet, SearchView,LocalUploadViewSet,ExternalUploadViewSet
#-----------------------------------------------------------------------------------------------
...
urlpatterns = [
    ...
    path('AddToFavorite/<int:user_id>/<str:article_id>/', FavoriteArticleViewSet, name='add_to_favorites'),
