...
from .views import LoginView, UtilisateursListView, ArticlesListView, FavorisView, FavoriteArticleListView, SearchView,LocalUploadViewSet,ExternalUploadViewSet
#-----------------------------------------------------------------------------------------------
...
urlpatterns = [
    ...
    path('favoris/', FavorisView.as_view(), name='favoris-list'),
    path('search/', SearchView.as_view(), name='article_search'), 
    path('user-favorite-articles/', FavoriteArticleListView.as_view(), name='user-favorite-articles'),
    #--------------------------------------------------------------------------------------------------#
